# Inlined from https://github.com/bytecodealliance/componentize-py/blob/c21fdfceda073cc96ceb8264b192a5db55d3f33a/bundled/poll_loop.py
...
from main_world.imports import types, streams, poll, outgoing_handler
...
from main_world.imports.streams import StreamError_Closed, InputStream
from main_world.imports.poll import Pollable
