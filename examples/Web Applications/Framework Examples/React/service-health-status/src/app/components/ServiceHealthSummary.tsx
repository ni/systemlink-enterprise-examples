...
const ServiceHealthSummary = ({
    ...
    const healthyPercent = totalServices > 0 ? Math.round((healthyCount / totalServices) * 100) : 0;
    const failedPercent = totalServices > 0 ? Math.round((failedCount / totalServices) * 100) : 0;
